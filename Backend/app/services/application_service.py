...
#                 raise HTTPException(
#                     status_code=400,
#                     detail="SSN required for credit evaluation",
#                 )
...
#             #decision = self.engine.decide(db_app.input_data)
...
#         print("DEBUG tier:", decision["tier"], type(decision["tier"]))
...
#     #     db_app.current_tier = decision["tier"]
