# # =============================================================
# # api/v1/scoring.py — RESCORE ENDPOINT (FIXED)
# # =============================================================
...
# ):
#     """
#     Manually re-trigger the scoring engine for an existing application.

#     Rules:
#     - Restricted to underwriters / admins
#     - Does NOT reset lifecycle state
...
#             detail=f"Cannot re-score application in state {app.status}",
#         )

#     try:
#         updated_app = service.re_score(application_id=application_id)
#         return updated_app
