...
# # Import all routers from the API layer
...
# # CORS Configuration
# # -----------------------------
# # Essential for allowing your React/Next.js frontend to communicate with this API.
# app.add_middleware(
#     CORSMiddleware,
...
# app.include_router(applications.router, prefix=f"{api_router}/applications", tags=["Applications"])
# app.include_router(scoring.router,      prefix=f"{api_router}/scoring",      tags=["Scoring"])
# app.include_router(decisions.router,    prefix=f"{api_router}/decisions",    tags=["Decisions"])
# app.include_router(overrides.router,    prefix=f"{api_router}/overrides",    tags=["Overrides"])
# app.include_router(portfolio.router,    prefix=f"{api_router}/portfolio",    tags=["Portfolio Analytics"])
# app.include_router(policies.router,     prefix=f"{api_router}/policies",     tags=["Policy Governance"])
